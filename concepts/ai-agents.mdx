---
title: "AI Agents"
description: "Understanding the AI agents in ReedAI Assistant"
---

ReedAI Assistant employs specialized AI agents that are fine-tuned for specific development tasks. Each agent has unique capabilities and expertise areas.

## What are AI Agents?

In ReedAI Assistant, an AI agent is a specialized interface to the underlying language model (Claude 3.5 Sonnet) that is:
...
ReedAI Assistant includes five specialized AI agents:
...
When using ReedAI Assistant, select the appropriate agent based on your task:
