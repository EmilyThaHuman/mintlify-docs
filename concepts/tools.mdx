---
title: "Tool Library"
description: "Understanding and using the ReedAI Assistant Tool Library"
---
...
<CardGroup>
  ...
  <Card title="API Reference" icon="code" href="/api-reference/authentication">
    View the API documentation for tool integration
  </Card>
  <Card
    title="Architecture"
  ...
  >
    Learn more about the ReedAI Assistant architecture
  </Card>
</CardGroup>
