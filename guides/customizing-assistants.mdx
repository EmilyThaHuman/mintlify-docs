...
<CardGroup cols={3}>
  <Card title="OpenAI" icon={<img src="/images/openai.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500">Latest preview</span>
      </div>
    </div>
  </Card>
  ...
  <Card title="Anthropic" icon={<img src="/images/claude.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500">Latest & most capable</span>
      </div>
      <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500">High capability</span>
      </div>
    </div>
  </Card>
  ...
  <Card title="Google" icon={<img src="/images/google.jpg" className="h-6 w-6" />}> 
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500">Proven performance</span>
      </div>
    </div>
  </Card>
  ...
  <Card title="xAI" icon={<img src="/images/xai.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
        <span className="font-medium">Grok 3 Beta</span>
        <span className="text-xs text-gray-500">Most capable</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-medium">Grok 3 Fast Beta</span>
        <span className="text-xs text-gray-500">Fast performance</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-medium">Grok 3 Mini Beta</span>
        <span className="text-xs text-gray-500">Compact</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="font-medium">Grok 3 Mini Fast Beta</span>
        <span className="text-xs text-gray-500">Fast & compact</span>
      </div>
    </div>
  </Card>
