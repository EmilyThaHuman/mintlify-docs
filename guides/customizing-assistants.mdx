...
<CardGroup cols={3}>
  <Card title="OpenAI" icon={<img src="/images/icons/openai.jpg" className="h-6 w-6" />}>
  ...
  <Card title="Anthropic" icon={<img src="/images/icons/claude.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Google" icon={<img src="/images/icons/google.jpg" className="h-6 w-6" />}> 
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Meta" icon={<img src="/images/icons/meta.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Mistral" icon={<img src="/images/icons/mistral.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Cohere" icon={<img src="/images/icons/cohere.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="DeepSeek" icon={<img src="/images/icons/deepseek.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Groq" icon={<img src="/images/icons/groq.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Perplexity" icon={<img src="/images/icons/perplexity.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
...
### <div className="flex items-center gap-2"><img src="/images/icons/openai.jpg" className="h-6 w-6" /> OpenAI (ChatGPT)</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/claude.jpg" className="h-6 w-6" /> Anthropic (Claude)</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/google.jpg" className="h-6 w-6" /> Google (Gemini)</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/mistral.jpg" className="h-6 w-6" /> Mistral AI</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/deepseek.jpg" className="h-6 w-6" /> DeepSeek</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/groq.jpg" className="h-6 w-6" /> Groq</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/xai.jpg" className="h-6 w-6" /> xAI (Grok)</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/cohere.jpg" className="h-6 w-6" /> Cohere</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/perplexity.jpg" className="h-6 w-6" /> Perplexity (Sonar)</div>
...
### <div className="flex items-center gap-2"><img src="/images/icons/openrouter.jpg" className="h-6 w-6" /> Dolphin Models</div>
