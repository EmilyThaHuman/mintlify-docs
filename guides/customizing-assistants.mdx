...
<CardGroup cols={3}>
  <Card title="OpenAI" icon={<img src="/public/images/icons/openai.jpg" className="h-6 w-6" />}>
  ...
  <Card title="Anthropic" icon={<img src="/public/images/icons/claude.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
        <span className="font-medium">Claude 3.7 Opus</span>
        <span className="text-xs text-gray-500">Most capable</span>
      </div>
      <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        <span className="font-medium">Claude 3.7 Haiku</span>
        <span className="text-xs text-gray-500">Fast & affordable</span>
      </div>
    </div>
  </Card>
  
  <Card title="Google" icon={<img src="/public/images/icons/google.jpg" className="h-6 w-6" />}> 
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Meta" icon={<img src="/public/images/icons/meta.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Mistral" icon={<img src="/public/images/icons/mistral.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="Cohere" icon={<img src="/public/images/icons/cohere.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
  ...
  <Card title="DeepSeek" icon={<img src="/public/images/icons/deepseek.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-gray-500">Code expert</span>
      </div>
    </div>
  </Card>
  
  <Card title="Groq" icon={<img src="/public/images/icons/groq.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        <span className="font-medium">LLaMA 3 70B</span>
        <span className="text-xs text-gray-500">High performance</span>
      </div>
    </div>
  </Card>
  
  <Card title="Perplexity" icon={<img src="/public/images/icons/perplexity.jpg" className="h-6 w-6" />}>
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
        <span className="font-medium">Perplexity Sonar</span>
        <span className="text-xs text-gray-500">Search-optimized AI</span>
      </div>
    </div>
  </Card>
</CardGroup>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/openai.jpg" className="h-6 w-6" /> OpenAI (ChatGPT)</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/claude.jpg" className="h-6 w-6" /> Anthropic (Claude)</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/google.jpg" className="h-6 w-6" /> Google (Gemini)</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/mistral.jpg" className="h-6 w-6" /> Mistral AI</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/deepseek.jpg" className="h-6 w-6" /> DeepSeek</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/groq.jpg" className="h-6 w-6" /> Groq</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/xai.jpg" className="h-6 w-6" /> xAI (Grok)</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/cohere.jpg" className="h-6 w-6" /> Cohere</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/perplexity.jpg" className="h-6 w-6" /> Perplexity (Sonar)</div>
...
### <div className="flex items-center gap-2"><img src="/public/images/icons/openrouter.jpg" className="h-6 w-6" /> Dolphin Models</div>
...
<CardGroup>
  ...
  <Card title="Assistant Templates" icon="robot" href="/guides/assistants/lead-generator">
    Explore ready-to-use assistant templates
  </Card>
</CardGroup> 